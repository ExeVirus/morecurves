...
local groups = {3,4,1,2,5,6}
shapes.curve3d.curve2_closed(inner, outer, -0.50,-0.25, 0.00, 0.25,groups,"models/a_1.obj")
shapes.curve3d.curve2_closed(inner, outer, -0.50, 0.00, 0.00, 0.50,groups,"models/a_2.obj")
shapes.curve3d.curve2_closed(inner, outer, -0.50, 0.25, 0.25, 0.75,groups,"models/a_3.obj")
shapes.curve3d.curve2_closed(inner, outer, -0.50, 0.50, 0.00, 1.00,groups,"models/a_4.obj")
shapes.curve3d.curve2_closed(rev_inner, rev_outer, -0.50,-0.25, 0.00, 0.25,groups,"models/a_1r.obj")
shapes.curve3d.curve2_closed(rev_inner, rev_outer, -0.50, 0.00, 0.00, 0.50,groups,"models/a_2r.obj")
shapes.curve3d.curve2_closed(rev_inner, rev_outer, -0.50, 0.25, 0.25, 0.75,groups,"models/a_3r.obj")
...
shapes.curve3d.point_curve_closed(v3(-0.5,-0.5,0.5), curve, -0.50,-0.25, 0.00, 0.25, nil, "models/b_1.obj")
shapes.curve3d.point_curve_closed(v3(-0.5,-0.5,0.5), curve, -0.50, 0.00, 0.00, 0.50, nil, "models/b_2.obj")
shapes.curve3d.point_curve_closed(v3(-0.5,-0.5,0.5), curve, -0.50, 0.25, 0.25, 0.75, nil, "models/b_3.obj")
shapes.curve3d.point_curve_closed(v3(-0.5,-0.5,0.5), curve, -0.50, 0.50, 0.00, 1.00, nil, "models/b_4.obj")
...
shapes.curve3d.point_curve_closed(v3(0.5,-0.5,-0.5), curve, -0.50,-0.25, 0.00, 0.25, nil, "models/_b_1.obj")
shapes.curve3d.point_curve_closed(v3(0.5,-0.5,-0.5), curve, -0.50, 0.00, 0.00, 0.50, nil, "models/_b_2.obj")
shapes.curve3d.point_curve_closed(v3(0.5,-0.5,-0.5), curve, -0.50, 0.25, 0.25, 0.75, nil, "models/_b_3.obj")
shapes.curve3d.point_curve_closed(v3(0.5,-0.5,-0.5), curve, -0.50, 0.50, 0.00, 1.00, nil, "models/_b_4.obj")
...
local curve_A1 = function(bottomh,toph,bottom_ty,top_ty,name)
    ...
    local curve_open = function(curve)
        shapes.curve3d.point_curve_open(v3(0.5,bottomh,-0.5), curve, bottomh, toph, bottom_ty, top_ty,{1,2,4,3,5,6},"no_export")
    end
...
local curve_A2 = function(bottomh,toph,bottom_ty,top_ty,name)
    ...
    shapes.curve3d.point_curve_open(v3(0.5,bottomh,-0.5), curve, bottomh, toph, bottom_ty, top_ty,{1,2,4,3,5,6},"no_export") --top, bottom, left
...
local curve_A2R = function(bottomh,toph,bottom_ty,top_ty,name)
    ...
    shapes.curve3d.point_curve_open(v3(0.5,bottomh,-0.5), curve, bottomh, toph, bottom_ty, top_ty,{1,2,4,5,5,6},"no_export") --top, bottom, left
    shapes.curve2d.wall({ v(0.5,bottomh,-0.5,0,0,-1,0,0), v(-0.5,bottomh,-0.5,0,0,-1,1,0) }, toph-bottomh, top_ty, 6) -- back
...
local curve_C= function(bottomh,toph,bottom_ty,top_ty,name)
    ...
    shapes.curve3d.point_curve_closed(point, full_curve, bottomh, toph, bottom_ty, top_ty, {1,2,3,4,5,6}, name)
end
...
local curve_CR= function(bottomh,toph,bottom_ty,top_ty,name)
    ...
    shapes.curve3d.point_curve_closed(point, full_curve, bottomh, toph, bottom_ty, top_ty, {1,2,4,3,5,6}, name)
end
...
local curve_C1= function(bottomh,toph,bottom_ty,top_ty,name)
    ...
    shapes.curve3d.point_curve_open(point, full_curve, bottomh, toph, bottom_ty, top_ty, {1,2,3,4,5,6}, "no_export") --right curve
    local endp = full_curve[#full_curve]
    shapes.curve3d.point_curve_open(point, {v(endp.x, bottomh, endp.z, 0, 0, 1, 0.5+endp.x,0), v(-0.5,bottomh,-0.5, 0, 0, 1, 1, 0)}, bottomh, toph, bottom_ty, top_ty, {1,2,3,6,5,4}, "no_export") --back
...
local curve_C1R= function(bottomh,toph,bottom_ty,top_ty,name)
    ...
    shapes.curve3d.point_curve_open(point, full_curve, bottomh, toph, bottom_ty, top_ty, {1,2,3,4,5,6}, "no_export") --left curve
    local startp = full_curve[1]
    shapes.curve3d.point_curve_open(point, {v(0.5,bottomh,-0.5, 0, 0, 1, 0, 0), v(startp.x, bottomh, startp.z, 0, 0, 1, startp.x,0)}, bottomh, toph, bottom_ty, top_ty, {1,2,3,6,5,4}, "no_export") --back
    shapes.curve2d.wall({ v(-0.5,bottomh,0.5,0,0,1,0,0), v(0.5,bottomh,0.5,0,0,1,1,0) }, toph-bottomh, top_ty, 5) -- front
    shapes.curve2d.wall({v(0.5,bottomh,0.5,1,0,0,0,0), v(0.5,bottomh,-0.5,1,0,0,1,0) }, toph-bottomh, top_ty, 4) -- right
